...
# build directory.
TCL_BUILD_LIB_SPEC='-L/home/andreask/dbn/lba/night/builds/win32-ix86/tcl/win/win32-ix86 -ltcl85'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-LC:/Tcl/lib -ltcl85'
...
# compiled.
TCL_SRC_DIR='/home/andreask/dbn/lba/night/builds/win32-ix86/tcl'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/home/andreask/dbn/lba/night/builds/win32-ix86/tcl/win/win32-ix86 -ltclstub85'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/Tcl/lib -ltclstub85'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/home/andreask/dbn/lba/night/builds/win32-ix86/tcl/win/win32-ix86/tclstub85.lib'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='C:/Tcl/lib/tclstub85.lib'
