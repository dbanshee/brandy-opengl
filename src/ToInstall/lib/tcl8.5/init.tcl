...
#
# ActiveState ActiveTcl 8.5.8.1.291945 Win32/x86, Fri Jan 22 22:23:57 PST 2010
#
...
namespace eval ::activestate {
	...
	maturity      {final}
	arch          {win32-ix86}
	buildtime,sec {1264227837}
	buildtime,fmt {Fri Jan 22 22:23:57 PST 2010}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.5.8.1.291945 Win32/x86 @ Fri Jan 22 22:23:57 PST 2010 / normal}
    }
}

package provide {ActiveTcl} {8.5.8.1.291945}
