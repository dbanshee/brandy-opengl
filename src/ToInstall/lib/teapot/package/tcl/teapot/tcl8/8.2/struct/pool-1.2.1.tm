...
# Meta description     Create and manipulate pool objects (of discrete
# Meta description     items)
# Meta license         BSD
# Meta platform        tcl
# Meta require         {Tcl 8.2}
# Meta require         cmdline
# Meta subject         {discrete items} struct pool finite
# Meta summary         struct::pool
# @@ Meta End
