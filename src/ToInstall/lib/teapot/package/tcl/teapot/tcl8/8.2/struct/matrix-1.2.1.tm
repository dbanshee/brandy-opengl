...
# Meta description     Create and manipulate matrix objects Create and
# Meta description     manipulate matrix objects
# Meta license         BSD
# Meta platform        tcl
# Meta require         {Tcl 8.2}
# Meta subject         matrix matrix
# Meta summary         struct::matrix struct::matrix v1
# @@ Meta End
