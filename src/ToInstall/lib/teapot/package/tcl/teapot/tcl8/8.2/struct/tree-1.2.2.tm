...
# Meta description     Create and manipulate tree objects Create and
# Meta description     manipulate tree objects
# Meta license         BSD
# Meta platform        tcl
# Meta recommend       tcllibc
# Meta require         {Tcl 8.2}
# Meta subject         tree in-order pre-order tree depth-first node
# Meta subject         serialization breadth-first post-order
# Meta summary         struct::tree v1 struct::tree
# @@ Meta End
