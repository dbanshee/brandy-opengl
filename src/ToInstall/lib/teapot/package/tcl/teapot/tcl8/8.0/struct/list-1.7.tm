...
# Meta description     Procedures for manipulating lists
# Meta license         BSD
# Meta platform        tcl
# Meta require         {Tcl 8.0}
# Meta require         cmdline
# Meta subject         permutation reduce {longest common subsequence}
# Meta subject         common {left outer join} comparison list reverse
# Meta subject         {right outer join} differential flatten map
# Meta subject         {first permutation} join equal swapping diff
# Meta subject         {full outer join} repetition folding subsequence
# Meta subject         {inner join} assign {generate permutations} equality
# Meta subject         filter {next permutation} {outer join} repeating
# Meta summary         struct::list
# @@ Meta End
