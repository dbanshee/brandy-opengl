...
# Meta category        Megawidget package widget::calendar Megawidget
# Meta description     Megawidget package widget::calendar Megawidget
# Meta license         BSD
# Meta platform        tcl
# Meta require         {Tcl 8.4}
# Meta require         {Tk 8.4}
# Meta require         snit
# Meta subject         widget snit megawidget widget snit megawidget
# Meta summary         widget widget_calendar
# @@ Meta End
