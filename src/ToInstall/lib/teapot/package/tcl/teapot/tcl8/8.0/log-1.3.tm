...
# Meta category        Logging facility
# Meta description     Procedures to log messages of libraries and
# Meta description     applications.
# Meta license         BSD
# Meta platform        tcl
# Meta require         {Tcl 8}
# Meta subject         message {message level} {log level} log
# Meta summary         log
# @@ Meta End
