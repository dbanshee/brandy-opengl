...
# Meta description     Define and create records (similar to 'C'
# Meta description     structures)
# Meta license         BSD
# Meta platform        tcl
# Meta require         {Tcl 8.2}
# Meta subject         struct {data structures} record
# Meta summary         struct::record
# @@ Meta End
