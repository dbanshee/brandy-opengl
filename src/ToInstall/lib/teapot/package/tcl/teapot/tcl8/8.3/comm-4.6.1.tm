...
# Meta description     The comm wire protocol A remote communication
# Meta description     facility for Tcl (8.3 and later)
# Meta license         BSD
# Meta platform        tcl
# Meta require         {Tcl 8.3}
# Meta require         snit
# Meta subject         comm ipc {remote execution} rpc message socket
# Meta subject         communication {remote communication} socket send tls
# Meta subject         rpc communication secure {remote execution}
# Meta subject         {remote communication} ssl ipc comm message
# Meta summary         comm_wire comm
# @@ Meta End
