...
# Meta description     Procedures to adjust, indent, and undent paragraphs
# Meta license         BSD
# Meta platform        tcl
# Meta require         {Tcl 8.2}
# Meta require         textutil::repeat
# Meta require         textutil::string
# Meta subject         undenting indenting justification adjusting TeX
# Meta subject         paragraph hyphenation formatting string
# Meta summary         textutil::adjust
# @@ Meta End
