...
set _ $dir ; set dir [file join $_ BWidget1.9] ; source [file join $dir pkgIndex.tcl] ; set dir $_ ; unset _
if {![package vsatisfies [package provide Tcl] 8.2]} return
set _ $dir ; set dir [file join $_ struct_tree2.1.2] ; source [file join $dir pkgIndex.tcl] ; set dir $_ ; unset _
set _ $dir ; set dir [file join $_ struct_stack1.4] ; source [file join $dir pkgIndex.tcl] ; set dir $_ ; unset _
...
set _ $dir ; set dir [file join $_ snit1.4.1] ; source [file join $dir pkgIndex.tcl] ; set dir $_ ; unset _
set _ $dir ; set dir [file join $_ tablelist_common4.12.1] ; source [file join $dir pkgIndex.tcl] ; set dir $_ ; unset _
if {![package vsatisfies [package provide Tcl] 8.5]} return
set _ $dir ; set dir [file join $_ snit2.3.1] ; source [file join $dir pkgIndex.tcl] ; set dir $_ ; unset _
