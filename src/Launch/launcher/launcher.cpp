...
// Crea un proceso win32, q lanza el interprete de tcl y termina
//
//	Banshee - 2007
...
*/
	...
	CreateProcess(NULL,"wish85.exe main.tcl",NULL,NULL,0,NORMAL_PRIORITY_CLASS,NULL,".",&si,&pi);
